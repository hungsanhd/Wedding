...
(function ($) {
	...
	var _ = {
		...
		init: function (options) {
			...
			var template = ['<svg viewBox="0 0 100 100" id="playable" version="1.1" xmlns="http://www.w3.org/2000/svg" width="33" height="33" data-play="playable" class="not-started playable">',
				'<g class="shape">',
